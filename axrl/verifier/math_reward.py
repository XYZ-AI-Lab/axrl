# Copied and adapted from https://github.com/volcengine/verl/blob/main/verl/utils/reward_score/math_reward.py
...
class MathVerifier(BaseVerifier):
    ...
    def verify(self, label: str | list[str], output_text: str, *, verbose: bool = False) -> float:
        ...
        if verbose:
            logger.info(f"MathVerifier: {score=}, {output_text=}, {label=}")
        return score
