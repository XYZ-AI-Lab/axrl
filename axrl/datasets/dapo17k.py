...
class DAPO17K(BaseDataset):
    @override
    def initialize(self) -> None:
        self.source = "BytedTsinghua-SIA/DAPO-Math-17k"
        data = self._load_from_hf(HfDataConfig(repo_id=self.source, filename="data/dapo-math-17k.parquet"))
